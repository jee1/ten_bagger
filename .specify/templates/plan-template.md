...
|-----------|--------|-------|
| I. Git-Content Source of Truth | PASS / NEEDS ATTENTION / VIOLATION | [explanation] |
| II. Point-in-Time Measurement (No Look-Ahead) | PASS / NEEDS ATTENTION / VIOLATION | [explanation] |
| III. Additive Performance Artifacts | PASS / NEEDS ATTENTION / VIOLATION | [explanation] |
| IV. Score Freeze Until Merge Gate | PASS / NEEDS ATTENTION / VIOLATION | [explanation] |
| V. Schema Contracts and Validation Discipline | PASS / NEEDS ATTENTION / VIOLATION | [explanation] |
